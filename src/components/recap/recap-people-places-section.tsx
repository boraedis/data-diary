...
// period-scoped data instead of all-time data — `LeaderboardTable`
...
/** The places table's columns, minus path and movement: the recap's rows
 * have no hierarchy, and it's already a fixed window. The country colour
