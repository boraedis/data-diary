import { HappinessCalendarChart } from "@/components/charts/mood-charts";
import { getHappinessCalendarData } from "@/lib/charts";
...
export default async function Page() {
  const data = await getHappinessCalendarData();
  return <HappinessCalendarChart data={data} />;
}
