import { SubsCalendarChart } from "@/components/charts/subs-charts";
import { getSubsDailyData } from "@/lib/charts";
...
export default async function Page() {
  const data = await getSubsDailyData();
  return <SubsCalendarChart data={data} />;
}
