import { DayTypeCalendarChart } from "@/components/charts/mood-charts";
import { getDayTypeCalendarData } from "@/lib/charts";
...
export default async function Page() {
  const data = await getDayTypeCalendarData();
  return <DayTypeCalendarChart data={data} />;
}
