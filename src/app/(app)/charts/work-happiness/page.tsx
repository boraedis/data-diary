import { WorkHappinessChart } from "@/components/charts/work-happiness-chart";
import { getWorkHappinessDays } from "@/lib/charts";
...
export default async function Page() {
  const data = await getWorkHappinessDays();
  return <WorkHappinessChart data={data} />;
}
