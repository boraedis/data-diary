import { DeviceCalendarChart } from "@/components/charts/technology-charts";
import { getDeviceUsageData } from "@/lib/charts";
...
export default async function Page() {
  const data = await getDeviceUsageData();
  return <DeviceCalendarChart data={data} />;
}
