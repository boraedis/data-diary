    ...
    <main className="mx-auto flex w-full max-w-md flex-col gap-4 px-4 py-8 md:max-w-2xl md:gap-6 md:py-12">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Link href="/manage/entertainment/movies/watchlist" className={buttonVariants({ variant: "outline", size: "sm" })}>
            Watchlist
          </Link>
          <Link href="/manage/entertainment/movies/ranking" className={buttonVariants({ variant: "outline", size: "sm" })}>
            Ranking
          </Link>
